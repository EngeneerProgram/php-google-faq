...
$web_google =  [
    ...
    [
        ...
        "risposta" => "<ol> Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:
...
<div class="container">
    <?php
    foreach ($web_google as $page) { ?>

        <?php echo $page['domanda'] ?>
        <?php echo $page['risposta'] ?>
